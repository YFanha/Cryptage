                ...
                if (verifValeurDecalage)
                {
                    for (int i = 0; i < txtMessageClair.TextLength; i++)
                    {
                        ...
                        else
                        {
                            ...
                            if (caractereDecimal > retourArriereMAJUSCULE && lower == false) //majuscule
                            {
                                caractereDecimal += decalage - nbrLettreAlpha;
                            }
                            else if (caractereDecimal > retourArriereMinuscule && lower == true) //minuscule
                            {
                                caractereDecimal += decalage - nbrLettreAlpha;
                            }
                            else
